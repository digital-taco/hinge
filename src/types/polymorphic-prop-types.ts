...
// CREDIT: https://www.benmvp.com/blog/polymorphic-react-components-typescript/
...
/**
 * Used to type polymorphic refs where the element type is not clearly defined.
 */
export type PolymorphicRef<C extends React.ElementType> = React.ComponentPropsWithRef<C>['ref']

/**
 * The same as PolymorphicComponentProps, but also supports a ref
 */
